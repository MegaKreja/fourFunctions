...
console.log('Rezultat - ', config.random);
...
console.log('Rezultat - ', config.minIntegerFromArray);
...
console.log('Rezultat - ', config.minIntegerFromString);
...
console.log('Rezultat - ', config.concatStringsByLength);
